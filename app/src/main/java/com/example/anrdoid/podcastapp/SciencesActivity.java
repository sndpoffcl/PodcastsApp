...
public class SciencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 10; i > 0; i--) {
            ...
            podcastList.add(new Podcast("Sciences Episode " + i, "21-1-2018", R.drawable.icon_podcast));
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(SciencesActivity.this, podcastList.get(position).getPodcastName(), Toast.LENGTH_LONG).show();
                Intent languageIntent = new Intent(SciencesActivity.this, PlayPodcastActivity.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent languageIntent = new Intent(SciencesActivity.this, MainActivity.class);
                startActivity(languageIntent);
            }
        });
    }
