...
public class ProgrammingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 10; i > 0; i--) {
            ...
            podcastList.add(new Podcast("Java Lesson " + i, "21-1-2018", R.drawable.icon_podcast));
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ProgrammingActivity.this, podcastList.get(position).getPodcastName(), Toast.LENGTH_LONG).show();
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent languageIntent = new Intent(ProgrammingActivity.this, MainActivity.class);
                startActivity(languageIntent);
            }
        });
    }
